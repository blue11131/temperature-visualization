...
This data package contains the data that powers the chart ["Annual temperature anomalies"](https://ourworldindata.org/grapher/annual-temperature-anomalies?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on May 24, 2026.
...
#### Full citation
Contains modified Copernicus Climate Change Service information (2026) – with major processing by Our World in Data. “Temperature anomaly” [dataset]. Contains modified Copernicus Climate Change Service information, “ERA5 monthly averaged data on single levels from 1940 to present 2” [original data].
